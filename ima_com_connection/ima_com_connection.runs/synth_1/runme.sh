...
HD_PWD='/home/matthew/Matthew/UCT/2020/Embedded3/Image-Masking-Accelerator/ima_com_connection/ima_com_connection.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log imu_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source imu_controller.tcl
